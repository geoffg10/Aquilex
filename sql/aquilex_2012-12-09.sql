...
# Database: aquilex
# Generation Time: 2012-12-09 18:34:23 +0000
# ************************************************************
...
VALUES
	...
	(4,'Annie Russell Theatre: Box Office',28.5927080000,-81.3475040000,1,1,'df0e0b28f1132c782bbbd6bb9bc71a2208983696');
...
CREATE TABLE `users` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_type_id` int(11) unsigned DEFAULT '1',
  ...
  `fb_updated_time` varchar(250) DEFAULT NULL,
